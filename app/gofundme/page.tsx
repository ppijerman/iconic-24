...
import mangrove2 from "@/assets/fundraising/mangroove2.jpg"
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-[1fr_550px] lg:gap-12 xl:grid-cols-[1fr_650px]">
              <div className="space-y-4">
                ...
                We are teaming up with <a className="transition duration-300 text-secondary font-bold hover:text-accent" href="https://lindungihutan.com/">
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  <Button
                    asChild
                    className="bg-secondary h-10 text-white hover:bg-accent px-8 text-sm font-medium md:text-xl shadow-sm"
                  >
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-white dark:bg-gray-800">
          <div className="container px-4 md:px-6">
            ...
            <div className="flex flex-col flex-1">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-secondary">Ready to double the impact?</h2>
                <p className="mt-4 text-gray-500 md:text-xl dark:text-gray-400">
                    ...
                    <span className="font-bold text-secondary"> we&apos;re taking action</span>.
                </p>
                <p className="mt-4 text-gray-500 md:text-xl dark:text-gray-400">
                    We are launching a campaign to plant trees in <span className="font-bold text-accent">Pasisir Pamanukan, West Java</span>. 
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
              <div>
                ...
                <p className="mt-4 text-gray-500 md:text-xl dark:text-gray-400">
                    ...
                    The country is an archipelago of over 17,000 islands, with around 6,000 inhabited. 
                    Major islands include Sumatra, Java, Kalimantan, Sulawesi, and Papua. Coastal communities in Indonesia rely heavily 
                    on the sea for their daily livelihoods through fishing, tourism, and trade.
                </p><br></br>
                <h3 className="text-3xl font-bold tracking-tighter sm:text-2xl text-secondary">How did the damage to the Pamanukan Coastal Area occur?</h3>
                <ul className="mt-4 text-gray-500 md:text-xl dark:text-gray-400 list-disc pl-7" >
                    <li>The construction of shrimp ponds without proper environmental impact assessments.</li>
                    <li>Abandoned shrimp ponds that failed, leading to degraded and erosion-prone landscapes.</li>
                </ul>
              </div>
              <Image
                src={mangrove1}
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-white dark:bg-gray-800">
          <div className="container px-4 md:px-6 space-y-8">
            <div className="space-y-4 text-center">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-secondary">How Mangrove Planting Helps</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-100 dark:bg-gray-900 rounded-lg p-6 shadow-md">
                  ...
                  <ul className="space-y-2 text-gray-500 dark:text-gray-400 list-disc pl-5">
                    ...
                    <li>Protection of villages and homes from seawater flooding and erosion.</li>
                    <li>Enhanced biodiversity.</li>
                    <li>Increased carbon sequestration.</li>
                  </ul>
                </div>
                <div className="bg-gray-100 dark:bg-gray-900 rounded-lg p-6 shadow-md">
                  <h3 className="text-xl font-bold mb-4">Economic Benefits for the Community</h3>
                  <ul className="space-y-2 text-gray-500 dark:text-gray-400 list-disc pl-5">
                    <li>Seedlings are purchased from local communities.</li>
                    <li>Creation of job opportunities for locals during the planting process.</li>
                    <li>Improved food sources for the community, including fish, crabs, shrimp, and other crustaceans.</li>
                  </ul>
                </div>
              </div>
          </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
              <div>
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-secondary">With your help, we are embarking on a dual mission:</h2>
                <ol className="mt-4 text-gray-500 md:text-xl dark:text-gray-400" style={{ listStyleType: 'decimal', paddingLeft: '50px'}}>
                    <li className="font-bold text-secondary">Supporting ICONIC 2024</li>
                    ...
                    <li className="font-bold text-secondary">Environmental Conservation in Indonesia</li>
                    <p style={{paddingBottom: '5px'}}>
              ...
              <div>
                ...
                <p className="mt-2 text-secondary md:text-l font-semibold dark:text-gray-400 pl-2">
                    Mangrove Species: Rhizophora Mangroves <a href="https://lindungihutan.com/blog/mengenal-bakau-hitam/"><span className="text-primary2">Learn more</span></a>.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-white dark:bg-gray-800">
          <div className="container px-4 md:px-6 space-y-8">
            <div className="space-y-4 text-center">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-secondary">How You Can Help</h2>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <div className="space-y-2 text-center">
                <h3 className="text-xl font-bold text-secondary">Share</h3>
              ...
              <div className="space-y-2 text-center">
                <h3 className="text-xl font-bold text-secondary">Donate</h3>
                <p className="text-gray-500 dark:text-gray-400">
              ...
              <div className="space-y-2 text-center">
                <h3 className="text-xl font-bold text-secondary">Engage</h3>
                <p className="text-gray-500 dark:text-gray-400">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
          <div className="container px-4 md:px-6">
            ...
            <Image
              ...
              />
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-secondary">Donate Now to Support Our Cause</h2>
