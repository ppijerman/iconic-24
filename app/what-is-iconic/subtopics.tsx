    ...
    <>
      <div className="flex flex-col md:flex-row w-full items-center">
        <div className="flex flex-col w-full items-center justify-center h-fit md:h-[350px] bg-accent p-5">
          ...
          <p className="p-5">
            ...
            development, abrupt changes possibly threaten the sustainability of
      ...
      <div className="flex flex-col md:flex-row w-full items-center">
        <div className="flex flex-col w-full items-center justify-center h-fit md:h-[350px] bg-primary3 p-5">
          ...
          <p className="p-5">
            Technological innovation is key to advancing low-carbon development,
            with renewable energy, energy storage, and smart grids leading the
            transformation. These innovations reduce fossil fuel dependence,
            enhance energy efficiency, and support sustainable practices across
            various sectors.
          </p>
        </div>
        <div className="flex flex-col w-full items-center justify-center h-fit md:h-[350px] bg-primary2 p-5">
          ...
          <p className="p-5">
            ...
            and construction sectors are one of the biggest carbon emitters on a
            global scale. Transformative ideas are needed to decarbonize the
            related sectors.
          </p>
        </div>
      </div>
